...
#[derive(Debug)]
pub struct PulseCompassProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PulseCompassProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PulseCompass processing");
    
    let mut processor = PulseCompassProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PulseCompassProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PulseCompassProcessor::new(false);
